 ...
 * @public
 */
export type SceneResponseBody = DemoModeResponseBody | RecognizeResultsResponseBody | ConversationResultResponseBody | SpeechMarkerResponseBody | StateResponseBody;
/**
 * @public
 */
