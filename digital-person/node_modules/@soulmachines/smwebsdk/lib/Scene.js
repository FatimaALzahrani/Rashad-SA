...
var index_1 = require("./websocket-message/index");
var SpeechState_1 = require("./websocket-message/enums/SpeechState");
var index_2 = require("./websocket-message/scene/index");
...
var Scene = /** @class */ (function () {
    function Scene(videoOrOptions, audioOnly, requestedUserMedia, requiredUserMedia, contentAwarenessDebounceTime, loggingConfig, tracerOptions, chromaKeyOptions) {
        if (audioOnly === void 0) { audioOnly = false; }
        if (requestedUserMedia === void 0) { requestedUserMedia = scene_1.UserMedia.MicrophoneAndCamera; }
        if (requiredUserMedia === void 0) { requiredUserMedia = scene_1.UserMedia.Microphone; }
        var _this = this;
        ...
        this._tracerOptions = {
            ...
            parentCtx: api_1.ROOT_CONTEXT,
            url: SmTelemetry_1.SmTracerProvider.defaultUrl,
        };
        this._chromaKeyOptions = undefined;
        this._sessionResumeEnabled = false;
        this._isResumedSession = false;
        this._sendMetadata = { pageUrl: false };
        this._onMicrophoneActive = new SmEvent_1.SmEvent();
        this._onCameraActive = new SmEvent_1.SmEvent();
        this.currentPersonaId = DEFAULT_PERSONA_ID;
        /** Returns the version of the webSdk and platformSdk */
        this.version = {
            webSdk: env_vars_1.websdkVersion,
            platformSdk: 'unknown',
        };
        ...
        if (this.isSceneOptions(videoOrOptions)) {
            ...
            this._requestedUserMedia = (0, convertToUserMedia_1.default)(options.requestedMediaDevices, requestedUserMedia);
            this._requiredUserMedia = (0, convertToUserMedia_1.default)(options.requiredMediaDevices, requiredUserMedia);
            this.contentAwarenessDebounceTime = options.contentAwarenessDebounceTime;
            this._loggingConfig = tslib_1.__assign(tslib_1.__assign({}, this._loggingConfig), (options.loggingConfig || {}));
            ...
            this._loggingConfig = tslib_1.__assign(tslib_1.__assign({}, this._loggingConfig), loggingConfig);
            if (tracerOptions) {
                this._tracerOptions = tracerOptions;
            }
            this._chromaKeyOptions = chromaKeyOptions;
        }
        this._logger = new Logger_1.Logger(this._loggingConfig.session.minLogLevel, this._loggingConfig.session.enabled);
        /**
         ...
         */
        this._onStateEvent = new SmEvent_1.SmEvent();
         ...
         */
        this._onRecognizeResultsEvent = new SmEvent_1.SmEvent();
         ...
         */
        this._onDisconnectedEvent = new SmEvent_1.SmEvent();
        ...
        this.connectionState = new ConnectionState_1.ConnectionState();
        this._metadataSender = new MetadataSender_1.MetadataSender(this);
            ...
            return tslib_1.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        this._session = new LocalSession_1.LocalSession(this._videoElement, this._logger);
                        return [3 /*break*/, 8];
                    case 1:
                    ...
                    case 4:
                        ...
                        if (server) {
                            config.tokenServerUri = (0, utils_1.getUrlHost)(data.url) + 'server/' + server;
                        }
                        return [3 /*break*/, 6];
                    case 5:
                        error_2 = _e.sent();
                        ...
                        throw (0, make_error_1.makeError)('Invalid API key', 'serverConnectionFailed');
                    case 6:
                        if (!config.tokenServerUri || !config.tokenServerAccessToken) {
                            throw (0, make_error_1.makeError)('Please authenticate via an API key or with a serverUri and accessToken', 'serverConnectionFailed');
                        }
                    ...
                    case 7:
                        ...
                        span = (_c = (_b = (_a = SmTelemetry_1.SmTracerProvider.getTracer()) === null || _a === void 0 ? void 0 : _a.startSpan('createSessionAndConnect')) === null || _b === void 0 ? void 0 : _b.setAttribute('sm.websdk.connection.pretraceinitduration.milliseconds', initTracerStartTime - connectStartTime)) === null || _c === void 0 ? void 0 : _c.setAttribute('sm.websdk.connection.traceinitduration.milliseconds', initTracerEndTime - initTracerStartTime);
                        if (this._isWebSocketOnly) {
                            this._session = new WebSocketSession_1.WebSocketSession(config.tokenServerUri, config.tokenServerAccessToken, this._logger);
                        }
                        else {
                            this._session = new Session_1.Session(this._videoElement, config.tokenServerUri, config.userText, config.tokenServerAccessToken, this._audioOnly, this._requestedUserMedia, this._requiredUserMedia, this._echoCancellationEnabled, this._logger, this.connectionState, this._chromaKeyOptions);
                        }
                        _e.label = 8;
                    case 8:
                        if (!this._session) {
                            throw (0, make_error_1.makeError)('Failed to create session', 'unknown');
                        }
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(!this._tracerOptions.disableTracing &&
                            !SmTelemetry_1.SmTracerProvider.isInitialized())) return [3 /*break*/, 4];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        telemetryHost = (0, utils_1.getUrlHost)((0, utils_1.convertWssToHttps)(tokenServerUri));
                        if (!telemetryHost) {
                    ...
                    case 2:
                        ...
                        try {
                            SmTelemetry_1.SmTracerProvider.init({
    ...
    Scene.prototype.sendOnewaySceneRequest = function (name, body) {
        ...
        var payload = {
            name: name,
            body: body,
            category: index_1.WebsocketCategory.Scene,
            kind: index_1.WebsocketKind.Request,
        };
    ...
    Scene.prototype.sendRequest = function (name, body) {
        ...
        return new Promise(function (resolve, reject) {
            if (!_this._session) {
                reject((0, make_error_1.makeError)('No session available', 'noSession'));
                return;
            }
    ...
    Scene.prototype.onSceneMessage = function (message) {
        ...
        if (body && name === 'state') {
            ...
            if (personaId) {
                var persona = new Persona_1.Persona(this, personaId);
        ...
        if (kind === index_1.WebsocketKind.Response && transaction) {
    ...
    Scene.prototype.processResponse = function (body, name, status, transaction) {
        ...
        if (pending) {
            if (status === 0) {
                ...
                // Failure
                var error = new index_2.SceneResponseError();
    ...
    Scene.prototype.controlMicrophoneMute = function (state) {
        ...
        if (state.persona &&
            ...
            for (var personaId in state.persona) {
                ...
                if (persona_state.speechState === SpeechState_1.SpeechState.Speaking) {
    ...
    Scene.prototype.sessionConnected = function (resumeRequested, isResumedSession, server, sessionId) {
        this.contentAwareness = new ContentAwareness_1.ContentAwareness(this, this.contentAwarenessDebounceTime, new Logger_1.Logger(this._loggingConfig.contentAwareness.minLogLevel, this._loggingConfig.contentAwareness.enabled));
        /*
    ...
    Scene.prototype.enableFlaggedFeatures = function (featureFlags) {
        this._serverControlledCameras = featureFlags.includes(StateResponseBody_1.FeatureFlag.UI_SDK_CAMERA_CONTROL);
    };
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.sent();
                        return [3 /*break*/, 3];
                    case 2: throw (0, make_error_1.makeError)('Connection has not been established', 'noConnection');
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!video) {
                            throw (0, make_error_1.makeError)('Cannot find HTMLVideoElement', 'noVideoElement');
                        }
                    ...
                    case 2:
                        ...
                        throw (0, make_error_1.makeError)('Cannot start media playback', 'userInteractionRequired');
                }
            });
        });
    };
    ...
    Scene.prototype.fetchAuthConfig = function (apiKey) {
        ...
        try {
            ...
            throw (0, make_error_1.makeError)('Broken API key', 'Failed to decode api key');
        }
