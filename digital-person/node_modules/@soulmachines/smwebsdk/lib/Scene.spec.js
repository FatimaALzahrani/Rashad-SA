...
var websocket_message_1 = require("./websocket-message");
var StateResponseBody_1 = require("./websocket-message/scene/response-body/StateResponseBody");
require("./ContentAwareness");
var LocalSession_1 = require("./LocalSession");
var Logger_1 = require("./utils/Logger");
var WebSocketSession_1 = require("./WebSocketSession");
var scene_1 = require("./types/scene");
var convertToUserMedia_1 = require("./utils/convertToUserMedia");
var convertToUserMedia_2 = require("./utils/__mocks__/convertToUserMedia");
var speechMarkerResult_1 = require("./utils/test-utils/speechMarkerResult");
...
describe('Scene', function () {
    ...
    var audioOnly = true;
    var requestedUserMedia = scene_1.UserMedia.Microphone;
    var requiredUserMedia = scene_1.UserMedia.Microphone;
    ...
    beforeEach(function () {
        Logger_1.Logger.prototype.log = logMock;
        scene = new Scene_1.Scene(videoElement, audioOnly, requestedUserMedia, requiredUserMedia, contentAwarenessDebounceTime, loggingConfig);
        jest.spyOn(scene.conversation, 'reset');
        jest.spyOn(scene, 'sendRequest').mockResolvedValue({});
    });
    it('creates a conversation', function () {
        expect(Conversation_1.Conversation).toHaveBeenCalled();
    });
    describe('connect', function () {
        it('should reject with history of retries when connection fails due to noScene', function () {
            Session_1.Session.prototype.connect = function () {
                var error = new Error();
                error.name = 'noScene';
                throw error;
            };
        ...
        describe('when its running under runtime host', function () {
            ...
            it('creates a local session', function () {
                expect(LocalSession_1.LocalSession).toHaveBeenCalledWith(videoElement, expect.any(Logger_1.Logger));
            });
            it('passes in the session logging config when creating a logger', function () {
                expect(Logger_1.Logger).toHaveBeenCalledWith(loggingConfig.session.minLogLevel, loggingConfig.session.enabled);
            });
        });
        describe('when is running in websocket only mode', function () {
            ...
            it('creates a websocket session', function () {
                expect(WebSocketSession_1.WebSocketSession).toHaveBeenCalledWith(serverUri, accessToken, expect.any(Logger_1.Logger));
            });
            it('passes in the session logging config when creating a logger', function () {
                expect(Logger_1.Logger).toHaveBeenCalledWith(loggingConfig.session.minLogLevel, loggingConfig.session.enabled);
            });
            ...
            describe('with params', function () {
                beforeEach(function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                scene = new Scene_1.Scene(videoElement, audioOnly, scene_1.UserMedia.Microphone, scene_1.UserMedia.MicrophoneAndCamera, contentAwarenessDebounceTime, loggingConfig);
                                return [4 /*yield*/, scene.connect(serverUri, userText, accessToken)];
                            case 1:
                                _a.sent();
                                return [2 /*return*/];
                ...
                it('creates a session', function () {
                    expect(Session_1.Session).toHaveBeenCalledWith(videoElement, serverUri, userText, accessToken, audioOnly, scene_1.UserMedia.Microphone, scene_1.UserMedia.MicrophoneAndCamera, true, // _echoCancellationEnabled
                    scene['_logger'], expect.any(ConnectionState_1.ConnectionState), undefined // no chromaKey option
                    );
                });
            });
            describe('with options object', function () {
                it('returns an error as the api key is not defined', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                _a.sent();
                                expect(Session_1.Session).not.toHaveBeenCalled();
                                return [2 /*return*/];
                        }
                    });
                }); });
        ...
        describe('when api key is not defined', function () {
            ...
            it('throws an error when called with no params', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
            ...
            it('throws an error when called with only the server uri', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
            ...
            it('throws an error when called with only the access token', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
            ...
            describe('when called with options object', function () {
                ...
                it('creates a session using the server uri and auth token passed in', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                _a.sent();
                                expect(Session_1.Session).toHaveBeenCalledWith(undefined, mockServerUri, undefined, mockAccessToken, expect.anything(), expect.anything(), expect.anything(), expect.anything(), scene['_logger'], expect.any(ConnectionState_1.ConnectionState), undefined // no chromaKey option
                                );
                                return [2 /*return*/];
                        }
                    });
        ...
        describe('when api key is defined', function () {
            ...
            beforeEach(function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    scene = new Scene_1.Scene({ apiKey: encodedApiKey });
            ...
            it('calls the server endpoint that is encoded in the api key', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, scene.connect()];
                        case 1:
            ...
            it('sends the encoded api key as a header', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, scene.connect()];
                        case 1:
            ...
            it('throws an error when the request for a JWT fails with a 401 response', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
            ...
            it('throws an error when the request for a JWT fails with a 404 response', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            mockFetchPromise = Promise.reject({
            ...
            it('does not create a session when a jwt request fails', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                var error_1;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                        ...
                        case 4:
                            expect(Session_1.Session).not.toHaveBeenCalled();
                            expect(LocalSession_1.LocalSession).not.toHaveBeenCalled();
                            expect(WebSocketSession_1.WebSocketSession).not.toHaveBeenCalled();
                            return [2 /*return*/];
                    }
                });
            }); });
            it('creates a session when calling with no params', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, scene.connect()];
                        case 1:
                            _a.sent();
                            expect(Session_1.Session).toHaveBeenCalledWith(undefined, // video element
                            mockUrl, undefined, // user text
                            mockJWT, false, // audioOnly
                            convertToUserMedia_2.mockedReturnValue, convertToUserMedia_2.mockedReturnValue, true, // _echoCancellationEnabled
                            scene['_logger'], expect.any(ConnectionState_1.ConnectionState), undefined // no chromaKey option
                            );
                            return [2 /*return*/];
                    }
            ...
            describe('with options object', function () {
                it('uses the url and jwt derived from the api keys auth server', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                    var userText;
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                            ...
                            case 1:
                                _a.sent();
                                expect(Session_1.Session).toHaveBeenCalledWith(undefined, mockUrl, userText, mockJWT, expect.anything(), expect.anything(), expect.anything(), expect.anything(), expect.anything(), expect.any(ConnectionState_1.ConnectionState), undefined // no chromaKey option
                                );
                                return [2 /*return*/];
                        }
                    });
            ...
            describe('calling with params', function () {
                ...
                it('uses the passed in values and ignores the API key', function () {
                    expect(Session_1.Session).toHaveBeenCalledWith(undefined, 'passed in server url', undefined, 'passed in access token', expect.anything(), expect.anything(), expect.anything(), expect.anything(), expect.anything(), expect.any(ConnectionState_1.ConnectionState), undefined // no chromaKey option
                    );
                });
    ...
    describe('onSceneMessage', function () {
        var message = {
            body: {
                scene: {
                    featureFlags: [
                        StateResponseBody_1.FeatureFlag.UI_CONTENT_AWARENESS,
                        StateResponseBody_1.FeatureFlag.UI_SDK_CAMERA_CONTROL,
                    ],
                },
            },
            category: websocket_message_1.WebsocketCategory.Scene,
            kind: websocket_message_1.WebsocketKind.Response,
            status: 1,
            name: 'state',
            transaction: '123',
        };
        ...
        describe('when a conversationResult message is received', function () {
            ...
            var conversationMessage = tslib_1.__assign(tslib_1.__assign({}, message), { name: 'conversationResult', body: body });
            beforeEach(function () {
                jest.spyOn(scene.conversation, 'onConversationResult');
        ...
        describe('when a speechMarker message received', function () {
            ...
            var speechMarkerMessage = tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, message), speechMarkerResult_1.showcardsMessage), { name: 'speechMarker', body: body, category: websocket_message_1.WebsocketCategory.Scene, kind: websocket_message_1.WebsocketKind.Response });
            beforeEach(function () {
        ...
        it('does not indicate that server controlled cameras are enabled when the message does not contain the UI_SDK_CAMERA_CONTROL flag', function () {
            scene.onSceneMessage(tslib_1.__assign(tslib_1.__assign({}, message), { body: {
                    scene: {
                        featureFlags: [],
                    },
                } }));
        ...
        describe('processing conversation state messages', function () {
            it('calls conversation.processStateMessage with the message body', function () {
                scene.onSceneMessage(tslib_1.__assign(tslib_1.__assign({}, message), { name: 'state' }));
            ...
            it('does not call conversation.processStateMessage when name is not state', function () {
                scene.onSceneMessage(tslib_1.__assign(tslib_1.__assign({}, message), { name: 'recognizeResults' }));
    ...
    describe('setMediaDeviceActive', function () {
        describe('noConnection error', function () {
            it('should be thrown when not connected', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
            ...
            it('should not be thrown when connected', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
    ...
    describe('constructor', function () {
        ...
        describe('defaults', function () {
            ...
            it('sets requested user media to MicrophoneAndCamera', function () {
                expect(scene['_requestedUserMedia']).toEqual(scene_1.UserMedia.MicrophoneAndCamera);
            });
            it('sets required user media to Microphone', function () {
                expect(scene['_requiredUserMedia']).toEqual(scene_1.UserMedia.Microphone);
            });
        ...
        describe('using multiple params', function () {
            beforeEach(function () {
                scene = new Scene_1.Scene(videoElement, audioOnly, scene_1.UserMedia.Microphone, scene_1.UserMedia.None, contentAwarenessDebounceTime, loggingConfig);
            });
            ...
            it('sets requested user media to the passed in value', function () {
                expect(scene['_requestedUserMedia']).toEqual(scene_1.UserMedia.Microphone);
            });
            it('sets required user media to the passed in value', function () {
                expect(scene['_requiredUserMedia']).toEqual(scene_1.UserMedia.None);
            });
        ...
        describe('using options object', function () {
            ...
            it('calls convertToUserMedia with the requested media devices, MicAndCam as fallback', function () {
                expect(convertToUserMedia_1.default).toHaveBeenCalledWith(requestedMediaDevices, scene_1.UserMedia.MicrophoneAndCamera);
            });
            it('calls convertToUserMedia with the required media devices, Mic as fallback', function () {
                expect(convertToUserMedia_1.default).toHaveBeenCalledWith(requiredMediaDevices, scene_1.UserMedia.Microphone);
            });
            it('calls requested user media with the return value from convertToUserMedia', function () {
                expect(scene['_requestedUserMedia']).toEqual(convertToUserMedia_2.mockedReturnValue);
            });
            it('calls required user media with the return value from convertToUserMedia', function () {
                expect(scene['_requiredUserMedia']).toEqual(convertToUserMedia_2.mockedReturnValue);
            });
            it('sets content awareness debounce time to the passed in value', function () {
                expect(scene.contentAwarenessDebounceTime).toEqual(contentAwarenessDebounceTime);
            });
            ...
            it('passes in the session logging config when creating a logger', function () {
                expect(Logger_1.Logger).toHaveBeenCalledWith(scene['_loggingConfig'].session.minLogLevel, scene['_loggingConfig'].session.enabled);
            });
        });
    });
    describe('startVideo', function () {
        it('should reject with a noVideoElement error when the video element does not exist', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            var scene;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should resolve to video=true audio=true and leave the video unmuted when it succeeds on the first try, using a video element parameter', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
        ...
        it('should resolve to video=true audio=true and leave the video unmuted when it succeeds on the first try', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it('should resolve to video=true audio=false and leave the video muted when it fails on the first try but succeeds on the second try', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        jest
        ...
        it('should reject with a userInteractionRequired error and leave the video muted when it fails twice', function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        jest
