                ...
                switch (_e.label) {
                    ...
                    case 7:
                        ...
                        if (this._isWebSocketOnly) {
                            ...
                            this._session = new Session(this._videoElement, config.tokenServerUri, config.userText, config.tokenServerAccessToken, this._audioOnly, this._requestedUserMedia, this._requiredUserMedia, this._echoCancellationEnabled, this._logger, this.connectionState, this._chromaKeyOptions);
                        }
                        _e.label = 8;
                    case 8:
                        if (!this._session) {
