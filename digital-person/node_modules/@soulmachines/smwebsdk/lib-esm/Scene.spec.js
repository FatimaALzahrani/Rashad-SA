        ...
        describe('when running in the default session mode', function () {
            describe('with params', function () {
                ...
                it('creates a session', function () {
                    ...
                    scene['_logger'], expect.any(ConnectionState), undefined // no chromaKey option
                    );
                });
            });
                ...
                it('creates a session using the server uri and auth token passed in', function () { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                _a.sent();
                                expect(Session).toHaveBeenCalledWith(undefined, mockServerUri, undefined, mockAccessToken, expect.anything(), expect.anything(), expect.anything(), expect.anything(), scene['_logger'], expect.any(ConnectionState), undefined // no chromaKey option
                                );
                                return [2 /*return*/];
                        }
                    });
        ...
        describe('when api key is defined', function () {
                ...
                it('uses the url and jwt derived from the api keys auth server', function () { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                _a.sent();
                                expect(Session).toHaveBeenCalledWith(undefined, mockUrl, userText, mockJWT, expect.anything(), expect.anything(), expect.anything(), expect.anything(), expect.anything(), expect.any(ConnectionState), undefined // no chromaKey option
                                );
                                return [2 /*return*/];
                        }
                    });
            ...
            describe('calling with params', function () {
                ...
                it('uses the passed in values and ignores the API key', function () {
                    expect(Session).toHaveBeenCalledWith(undefined, 'passed in server url', undefined, 'passed in access token', expect.anything(), expect.anything(), expect.anything(), expect.anything(), expect.anything(), expect.any(ConnectionState), undefined // no chromaKey option
                    );
                });
