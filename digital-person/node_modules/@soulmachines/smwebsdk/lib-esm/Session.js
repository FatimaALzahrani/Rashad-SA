...
import { initWebGL_rgb_with_canvas, render_rgb, updateChromaKeyOptions, } from './dedicated-workers/chroma-key.worker';
...
var Session = /** @class */ (function () {
    ...
    Session.prototype.processFrameForChromaKey = function (now, metadata) {
        if (this._chromaKeyedCanvas) {
            ...
            render_rgb(this._chromaKeyedCanvas.width, this._chromaKeyedCanvas.height, this._videoElement);
            this._videoElement.requestVideoFrameCallback(this.processFrameForChromaKey.bind(this));
        }
    };
    ...
    Session.prototype.setupRequestAnimationFrameChromaKeyedVideo = function () {
        ...
        var update = function () {
            if (_this._chromaKeyedCanvas) {
                ...
                render_rgb(_this._chromaKeyedCanvas.width, _this._chromaKeyedCanvas.height, _this._videoElement);
                setTimeout(function () {
